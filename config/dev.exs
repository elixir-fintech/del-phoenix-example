...
config :del_example, DelExampleWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "QAFDSKx5jOLyzQp3SK696IIFUu4QFq4X4ImaIVrsbw+b0+OzlYZZjvhRdhhwV3ra",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:del_example, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:del_example, ~w(--watch)]}
  ]
