defmodule DelExampleWeb.CoreComponents do
  @moduledoc """
  ...
  def back(assigns) do
    ...
    <div class={["mt-16", @class]}>
      <.link
        navigate={@navigate}
        class="text-sm font-semibold leading-6 hover:opacity-70"
      >
  ...
  @doc """
  Renders back/next page navigation.
  """
  ...
  def page_nav(assigns) do
    ...
    <div class="mt-16 flex justify-between items-center">
      <.link
        ...
        class="text-sm font-semibold leading-6 hover:opacity-70"
      >
        <.icon name="hero-arrow-left-solid" class="mr-1 size-3" />
        {render_slot(@back)}
      </.link>
      <.link
      ...
      >
        {render_slot(@next)}
        <.icon name="hero-arrow-right-solid" class="ml-1 size-3" />
      </.link>
    </div>
    """
  end
  ...
  def translate_error({msg, opts}) do
    if count = opts[:count] do
      Gettext.dngettext(DelExampleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DelExampleWeb.Gettext, "errors", msg, opts)
    end
  end
